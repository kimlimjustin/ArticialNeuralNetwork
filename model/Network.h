...
class Network {
private:
    std::vector<std::unique_ptr<Layer>> m_layers;  ///< Collection of network layers
    std::string m_name;                            ///< Network name/identifier
...
public:
    ...
    //【更改记录】
    //-------------------------------------------------------------
    std::string getStructureInfo() const;
